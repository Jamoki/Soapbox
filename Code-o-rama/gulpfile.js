// Arguments: 
// --production   Do a production build
// --minify       Minify the source code
...
var paths = {
  ...
  images: ['**/*.png'],
  cursors: ['**/*.cur'],
  less: ['style/bootswatch.less', '*.less', 'views/**/*.less'],
  markdown: ['**/*.md']
};
...
function startLiveReload() {
  ...
  gulp.watch(paths.cursors, ['cursors']);
  gulp.watch(paths.icons, ['icons']);
  gulp.watch(paths.html, ['html']);
  gulp.watch(paths.script, ['script']);
  gulp.watch(paths.less, ['less']);
  gulp.watch(paths.markdown, ['markdown']);
  // NOTE: This causes too many open files
  // gulp.watch(path.join(bowerComponentsPath, '**'), ['lib']);
